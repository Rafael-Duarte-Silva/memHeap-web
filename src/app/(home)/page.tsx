    ...
    <main>
      <section className="max-w-6xl mx-auto mb-20">
        ...
        <section className="flex flex-wrap gap-4 text-sm">
          ...
          <Button as="a" href="mailto:your@email.com">
            Email
          </Button>
        </section>
      </section>
      ...
      <section className="max-w-6xl mx-auto mb-20">
        ...
        <div className="flex flex-wrap gap-4">
          {["Memory", "Systems", "Performance", "Networking", "Compilers"].map(
            (category) => (
      ...
      <footer className="max-w-6xl mx-auto text-center text-neutral-500 text-sm font-sans">
        <p className="mb-2">
          If you like this kind of content, feel free to reach out or follow my
          work.
        </p>
        <p>© {new Date().getFullYear()} memHeap — built one note at a time.</p>
      </footer>
    </main>
  );
}
